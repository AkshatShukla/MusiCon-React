        ...
        <div className="card shadow p-3 mb-5 bg-white rounded">
            ...
            <div className="card-body">
                ...
                <form action={track.externalUrl}>
                    <button type='btn' type='btn' className="btn btn-outline-dark" style={{marginBottom: '10px'}}>Show on Spotify</button>
                </form>
            </div>
            ...
            <div className="card-footer ">
                <button type='btn' className="btn btn-outline-danger" onClick={() => removeTrack(track, 'track')}>
